/*Alot of the code in the file is taken from mipslabfunc.c
  which is written 2015 by F Lundevall
  Some parts are original code written by Axel Isaksson
  and modified 2017-04-31 by Ture Teknolog 
  and modified by Harry Lazaridis and Malcolm Liljedahl
...
void tick( unsigned int * timep )
{
  ...
  if( (t & 0x000f0000) >= 0x00000060 ) t += 0x000000a0;
  /* Seconds are now OK */
